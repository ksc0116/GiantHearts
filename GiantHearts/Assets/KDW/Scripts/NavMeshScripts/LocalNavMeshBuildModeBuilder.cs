...
public class LocalNavMeshBuildModeBuilder : MonoBehaviour
{
    ...
    {
        NavMeshSourceBuildModeTag.Collect(ref m_Sources);
    ...
    public void SetBuileMode()
    {
        //isBuildMode = isBuildMode ? true : false;
        isBuildMode = true;
    }
}
